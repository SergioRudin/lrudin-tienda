...
public class ProductoService {
    ...
    @Transactional(readOnly = true)
public List<Producto> consultaCategoria(Integer idCategoria, double precioInf, double precioSup) {
    return productoRepository.consultaCategoria(idCategoria, precioInf, precioSup);
}
}